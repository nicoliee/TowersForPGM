...
public class StatsConfig {
  ...
  public void toggleStats(CommandSender sender) {
    ...
    String cancelStatsMessage = isStatsCancel
        ? "&aStats collection has been enabled."
  ...
  public void setDefaultTable(CommandSender sender, String table) {
    ...
    SendMessage.sendToPlayer(
        sender, languageManager.getPluginMessage("table.success").replace("{table}", table));
  }
  ...
  public void addTable(CommandSender sender, String table) {
    ...
    SendMessage.sendToPlayer(
        sender, languageManager.getPluginMessage("table.created").replace("{table}", table));
  }
  ...
  public void deleteTable(CommandSender sender, String table) {
    ...
    SendMessage.sendToPlayer(
        sender, languageManager.getPluginMessage("table.deleted").replace("{table}", table));
  }
  ...
  public void listTables(CommandSender sender) {
    ...
    SendMessage.sendToPlayer(
        sender, languageManager.getPluginMessage("table.list").replace("{list}", tablesList));
  }
  ...
  public void addTableForMap(CommandSender sender, String table) {
    ...
    SendMessage.sendToPlayer(
        sender,
        languageManager
            .getPluginMessage("table.mapAdded")
            .replace("{map}", mapName)
            .replace("{table}", table));
  }
  ...
  public void deleteTableForMap(CommandSender sender) {
    ...
    if (!ConfigManager.getMapTables().containsKey(mapName)) {
      SendMessage.sendToPlayer(
          sender, languageManager.getPluginMessage("table.mapNotExists").replace("{map}", mapName));
      return;
    }
    ConfigManager.removeMapTable(mapName);
    SendMessage.sendToPlayer(
        sender, languageManager.getPluginMessage("table.mapDeleted").replace("{map}", mapName));
  }

  public void addTempTable(CommandSender sender, String table) {
    ConfigManager.addTempTable(table);
    SendMessage.sendToPlayer(
        sender, languageManager.getPluginMessage("table.tempAdded").replace("{table}", table));
  }
