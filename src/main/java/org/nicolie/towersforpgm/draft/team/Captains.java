...
public class Captains {
  ...
  public boolean isCaptainByName(String playerName) {
    if (playerName == null) return false;
    String captain1Name = getCaptain1Name();
    String captain2Name = getCaptain2Name();
    return (captain1Name != null && captain1Name.equalsIgnoreCase(playerName))
        || (captain2Name != null && captain2Name.equalsIgnoreCase(playerName));
  }

  public UUID getCaptain(int teamNumber) {
    if (teamNumber == 1) {
      return captain1;
