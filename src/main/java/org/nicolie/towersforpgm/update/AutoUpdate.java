...
public class AutoUpdate {
  ...
  private static final String url =
      "https://api.github.com/repos/nicoliee/TowersForPGM/releases/latest";
      ...
      try {
        ...
        if (compareVersions(currentVersion, latestVersion) >= 0) {
          ...
          SendMessage.sendToAdmins(
              "§8[§bTowersForPGM§8] §eNew version available: §7v" + latestVersion);
  ...
  /**
   * Compara dos versiones en formato "x.y.z". Devuelve: - Un valor negativo si `version1` <
   * `version2` - Cero si `version1` == `version2` - Un valor positivo si `version1` > `version2`
   */
