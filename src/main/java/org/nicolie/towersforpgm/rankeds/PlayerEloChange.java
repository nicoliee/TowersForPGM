    ...
    public void sendMessage() {
        org.bukkit.Bukkit.getScheduler().runTaskLater(
            ...
            if (!previousRank.equals(newRank)) {
                ...
                message = previousRank.getPrefixedRank(true) + arrow + newRank.getPrefixedRank(true) + " §f" + newElo + " (" + color + sign + eloChange + "§f)";
            } else {
                message = newRank.getPrefixedRank(true) + " §f" + newElo + " (" + color + sign + eloChange + "§f)";
            }
