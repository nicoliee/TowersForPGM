...
public class HelpConfig {
  ...
  public static void sendDraftHelp(CommandSender sender) {
    ...
    sender.sendMessage(
        "§6/towers §bdraft §asuggestions §7- Muestra sugerencias de configuración para el draft.");
    sender.sendMessage(
        "§6/towers §bdraft §atimer §7- Muestra o modifica el temporizador del draft.");
    sender.sendMessage(
        "§6/towers §bdraft §aprivate <true/false> §7- Define si el draft es privado.");
    sender.sendMessage("§6/towers §bdraft §aorder <A[AB]+> §7- Establece el orden del draft.");
    sender.sendMessage(
        "§6/towers §bdraft §amin <size> §7- Establece el tamaño mínimo del draft. para aplicar el orden custom.");
  }

  public static void sendPreparationHelp(CommandSender sender) {
    sender.sendMessage("§6§m--------------------§6§lPreparation §6§m--------------------");
    sender.sendMessage(
        "§6/towers §bpreparation §aadd §7- Añade una nueva configuración de preparación.");
    sender.sendMessage(
        "§6/towers §bpreparation §aremove §7- Elimina una configuración de preparación.");
    sender.sendMessage(
        "§6/towers §bpreparation §amax <x> <y> <z> §7- Define la esquina máxima del área.");
    sender.sendMessage(
        "§6/towers §bpreparation §amin <x> <y> <z> §7- Define la esquina mínima del área.");
    sender.sendMessage(
        "§6/towers §bpreparation §atimer <mins> §7- Establece el tiempo de preparación en minutos.");
    sender.sendMessage(
        "§6/towers §bpreparation §ahaste <mins> §7- Establece la duración del efecto de haste.");
    sender.sendMessage(
        "§6/towers §bpreparation §alist §7- Lista todas las configuraciones de preparación.");
  }
  ...
  public static void sendStatsHelp(CommandSender sender) {
    ...
    sender.sendMessage(
        "§6/towers §bstats §atoggle §7- Activa o desactiva la visualización de estadísticas.");
  ...
  public static void sendRankedHelp(CommandSender sender) {
    ...
    sender.sendMessage(
        "§6/towers §branked §asize [2-12] §7- Establece o muestra el tamaño de partidas rankeds.");
    sender.sendMessage(
        "§6/towers §branked §aorder [A[AB]+] §7- Establece o muestra el orden de draft rankeado.");
    sender.sendMessage(
        "§6/towers §branked §amatchmaking [true/false] §7- Activa o desactiva el matchmaking.");
    sender.sendMessage(
        "§6/towers §branked §aaddmap §7- Añade el mapa actual a la lista de mapas para rankeds.");
    sender.sendMessage(
        "§6/towers §branked §aremovemap §7- Elimina el mapa actual de la lista de mapas para rankeds.");
    sender.sendMessage(
        "§6/towers §branked §aaddtable <tabla> §7- Añade una nueva tabla para rankeds.");
    sender.sendMessage(
        "§6/towers §branked §aremovetable <tabla> §7- Elimina una tabla para rankeds.");
    sender.sendMessage(
