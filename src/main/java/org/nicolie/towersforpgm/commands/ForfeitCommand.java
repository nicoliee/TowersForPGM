...
public class ForfeitCommand implements CommandExecutor{
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (ConfigManager.getRankedTables().contains(ConfigManager.getTempTable()) || matchPlayer.isObserving()) {
        ...
        if (!forfeitedPlayers.add(matchPlayer.getId())) {
            matchPlayer.sendWarning(Component.text(languageManager.getPluginMessage("ranked.alreadyForfeited")));
            return true;
        }
        ...
        if (allForfeited) {
            ...
            match.sendMessage(Component.text(Queue.RANKED_PREFIX + languageManager.getPluginMessage("ranked.forfeit")
